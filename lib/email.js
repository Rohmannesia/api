...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="contacts@rohmanzx.my.id">GMAIL</a></span></span>
            <span style="display: block;"><br>Regards,<br>ROHMANZX</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"ROHMANZX" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - ROHMANZX API`,
        html: inboxGmail,
      };
